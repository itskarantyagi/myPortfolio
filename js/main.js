...
if (document.getElementById("about-div").style.display === "block")
    {
...
if (document.getElementById("design-div").style.display === "block")
    {
    document.getElementById("about-div").style.display = "none";
    document.getElementById("design-div").style.display = "none";
    document.getElementById("development-div").style.display = "none";
...
function my_work_div()
      ...
      if (document.getElementById("development-div").style.display === "block")
          {
          document.getElementById("about-div").style.display = "none";
          document.getElementById("design-div").style.display = "none";
          document.getElementById("development-div").style.display = "none";
...
function jukebox_div()
            ...
            if (document.getElementById("jukebox-div").style.display === "block")
                {
                document.getElementById("about-div").style.display = "none";
                document.getElementById("design-div").style.display = "none";
                document.getElementById("development-div").style.display = "none";
